          ...
          <form onSubmit={handleTeacherSubmit} className="space-y-4" autoComplete="off" data-lpignore="true">
            <div>
              ...
              <input
                ...
                placeholder="Nhập địa chỉ email giáo viên..."
                autoComplete="off"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-ocean-600 hover:bg-ocean-500 active:scale-95 text-white font-bold text-xs sm:text-sm rounded-xl transition shadow-md disabled:opacity-50 cursor-pointer"
            >
